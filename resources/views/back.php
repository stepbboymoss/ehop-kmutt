...
<html lang="en">
    ...
    <body data-spy="scroll" data-offset="70" data-terget="#home">
                                ...
                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordion">
                                    <div class="card-body">
                                        <ul class="unordered-lists" >
                                            <h5>เส้นสีเหลือง</h5>
                                            <h6>
                                                <li><a data-toggle="modal" data-target="#myModal">จุดจอดท่ารถ มจธ. (จุดจอดที่ 1)</a></li>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="col-md-12 col-lg-12">
                    <a class="blog-img" ><img src="{{ URL::asset('assets/img/blog-one.jpg') }}" alt="blog-one"></a>
                    <div class="blog-info">
                        <div class="date-box">
                            <span class="month">จุดจอด</span> 01 
                        </div>
                        <div class="title-meta">
                            <h3>จุดจอดท่ารถ มจธ. (จุดจอดที่ 1)</h3>
                        </div>
                    </div>
